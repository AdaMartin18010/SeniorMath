...
立体几何研究三维空间中的几何体及其性质。本章将系统介绍空间几何基础、多面体、旋转体、空间向量以及立体几何的计算方法。
...
> 以上例题覆盖立体几何核心知识点，配有详细解答，便于学习者理解与空间思维训练。
> The above examples cover the core knowledge points of solid geometry, with detailed solutions to help learners understand and practice spatial thinking.
