...
### 例题1：定积分的计算 | Example 1: Definite Integral Calculation
**题目 | Problem**：计算定积分 ∫₀¹ x dx。
**解答 | Solution**：
∫₀¹ x dx = [1/2 x²]₀¹ = 1/2。
The definite integral is 1/2.

### 例题2：面积计算 | Example 2: Area Calculation
**题目 | Problem**：已知曲线y = x²在区间[0,1]下的面积是多少？
**解答 | Solution**：
面积=∫₀¹ x² dx = [1/3 x³]₀¹ = 1/3。
The area under y = x² from 0 to 1 is 1/3.

### 例题3：积分的线性性质 | Example 3: Linearity of Integral
**题目 | Problem**：计算∫₀² (3x+1) dx。
**解答 | Solution**：
∫₀² (3x+1) dx = 3∫₀² x dx + ∫₀² 1 dx = 3×2 + 2 = 8。
The result is 8.

### 例题4：旋转体体积 | Example 4: Volume of Solid of Revolution
**题目 | Problem**：已知y = x²在[0,2]上的旋转体体积是多少？
**解答 | Solution**：
体积=π∫₀² (x²)² dx = π∫₀² x⁴ dx = π[1/5 x⁵]₀² = π×32/5 = 32π/5。
The volume is 32π/5.

### 例题5：积分应用 | Example 5: Application of Integral
**题目 | Problem**：计算定积分 ∫₀^π sin²x dx。
**解答 | Solution**：
...
### 例题6：换元积分法 | Example 6: Substitution Method
**题目 | Problem**：计算定积分 ∫₀¹ x·e^{x²} dx。
**解答 | Solution**：
令u=x²，du=2x dx，x=0时u=0，x=1时u=1
∫₀¹ x·e^{x²} dx=1/2∫₀¹ e^u du=1/2(e^1−e^0)=1/2(e−1)
By substitution, the result is (e−1)/2.

### 例题7：分部积分法 | Example 7: Integration by Parts
**题目 | Problem**：计算定积分 ∫₀^1 x·lnx dx。
**解答 | Solution**：
设u=lnx，dv=x dx，du=1/x dx，v=1/2x²
∫x·lnx dx=1/2x²lnx−∫1/2x²·1/x dx=1/2x²lnx−1/4x²+C
代入0,1得结果为−1/4
By parts, the result is −1/4.

### 例题8：积分应用创新 | Example 8: Innovative Application of Integral
**题目 | Problem**：已知y=x²在[0,1]上绕x轴旋转一周所得立体的体积是多少？
**解答 | Solution**：
V=π∫₀¹(x²)² dx=π∫₀¹ x⁴ dx=π[1/5x⁵]₀¹=π/5
The volume is π/5.

---

> 以上例题覆盖积分与应用核心知识点，配有详细解答，便于学习者理解与创新训练。
> The above examples cover the core knowledge points of integrals and their applications, with detailed solutions to help learners understand and practice.
