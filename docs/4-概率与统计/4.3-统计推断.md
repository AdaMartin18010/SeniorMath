...
**题目**：样本均值为10，标准差为2，样本容量为25，求均值的95%置信区间（正态分布）。
**解答**：
...
**题目**：某药品声称治愈率为80%，现抽样100人，发现治愈率为75%，能否认为药品达标？（α=0.05）
**解答**：
H₀: p=0.8，H₁: p<0.8
...
**题目**：已知x:1,2,3,4,5，y:2,4,6,8,10，求y关于x的回归方程。
**解答**：
显然y=2x。
...
> 以上创新与挑战性例题进一步提升了统计推断模块的深度与广度，便于学习者进阶训练。
