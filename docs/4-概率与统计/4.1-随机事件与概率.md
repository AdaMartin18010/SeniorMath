...
**题目**：从1~10中随机取一个数，取到偶数的概率是多少？
**解答**：
偶数有2,4,6,8,10，共5个，概率=5/10=1/2。

### 例题3：互斥事件概率

**题目**：从1~5中随机取一个数，取到1或3的概率是多少？
**解答**：
P(1或3)=P(1)+P(3)=1/5+1/5=2/5。

### 例题4：独立事件概率

**题目**：抛掷两枚硬币，均为正面的概率是多少？
**解答**：
P(正,正)=1/2×1/2=1/4。

### 例题5：条件概率

**题目**：袋中有3个红球2个白球，随机取出一个是红球的概率是多少？若已知取出的是彩球，求是红球的条件概率。
**解答**：
P(红)=3/5。
...
**题目**：袋中有3个红球2个白球，连续取两次，每次取后放回，求两次都取到红球的概率。
**解答**：
每次取红球概率3/5，两次都取到红球概率=(3/5)×(3/5)=9/25。

### 例题7：条件概率综合

**题目**：已知A、B为独立事件，P(A)=0.4，P(B)=0.5，求P(A∪B)。
**解答**：
P(A∪B)=P(A)+P(B)−P(A)P(B)=0.4+0.5−0.2=0.7

### 例题8：概率逆向思维

**题目**：抛掷两枚骰子，已知点数和为7，求其中一枚为4的概率。
**解答**：
点数和为7的组合有(1,6),(2,5),(3,4),(4,3),(5,2),(6,1)，共6种，其中有4的为(3,4),(4,3)，共2种，概率=2/6=1/3。

---

> 以上创新与挑战性例题进一步提升了随机事件与概率模块的深度与广度，便于学习者进阶训练。
