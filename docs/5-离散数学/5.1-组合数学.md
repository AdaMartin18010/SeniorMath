...
**题目**：从5人中选2人排成一排，有多少种不同排法？
**解答**：
A₅²=5×4=20种。

### 例题2：组合问题

**题目**：从6人中选3人组成小组，有多少种不同选法？
**解答**：
C₆³=20种。

### 例题3：鸽巢原理

**题目**：任取51个整数，必有两个数差为100的倍数。证明。
**解答**：
将51个数分别除以100，余数只有0~99共100种，必有两个数余数相同，其差为100的倍数。

### 例题4：递推关系

**题目**：已知递推数列a₁=2, aₙ₊₁=2aₙ+1，求aₙ的通项。
**解答**：
通项aₙ=2^{n+1}-1。

### 例题5：计数原理

**题目**：用1,2,3组成三位数，有多少个能被3整除？
**解答**：
所有三位数：3×3×3=27个。
能被3整除的：枚举各位数字和能被3整除的情况，共9个。

---

> 以上例题覆盖组合数学核心知识点，配有详细解答，便于学习者理解与创新训练。

## 创新与挑战性例题

### 例题6：错排问题

**题目**：有4本不同的书要放在4个不同的位置，要求每本书都不放在原来的位置，有多少种放法？
**解答**：
错排数D₄=9。

### 例题7：多重组合

**题目**：从5种水果中任选3种，每种可选多次，共有多少种不同选法？
**解答**：
相当于将3个球放入5个盒子，C₇³=35种。

### 例题8：鸽巢原理综合

**题目**：任取101个整数，必有两个数模100同余。证明。
**解答**：
余数只有0~99共100种，101个数必有两个余数相同。

---

> 以上创新与挑战性例题进一步提升了组合数学模块的深度与广度，便于学习者进阶训练。
